                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        ...
                        <div className="space-y-6 text-muted-foreground text-lg leading-relaxed">
                            <p>
                                بدأت رحلة مع <strong>كارما استور (Karma Store)</strong> منذ أكثر من 5 سنوات بهدف واحد: تقديم تجربة بث تلفزيوني لا تشوبها شائبة لمستخدمينا حول العالم. نحن لسنا مجرد مزود خدمة، بل نحن شركاؤك في ترفيه منزلي بلا حدود.
                            </p>
                            <p>
